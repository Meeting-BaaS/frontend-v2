...
import { isMultiDayEvent } from "@/lib/utils/calendar-helpers";
...
export function WeekView({
  ...
  return (
    <div data-slot="week-view" className="flex h-full flex-col">
      <div className="bg-background/80 border-border/70 sticky -top-9 z-30 grid grid-cols-8 border-y backdrop-blur-md uppercase">
