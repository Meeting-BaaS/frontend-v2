...
// Column headers - must be written explicitly for Tailwind JIT to detect them
// These match the widths defined in columns.tsx
const tableHeaders = [
  {
    label: "Email",
    width: "min-w-[280px] max-w-[450px] w-[45%]",
  },
  {
    label: "Role",
  ...
  {
    label: "Joined On",
    width: "min-w-[140px] max-w-[200px] w-[20%]",
  },
  {
    label: "",
    width: "min-w-[80px] max-w-[100px] w-[10%]",
  },
] as const;
