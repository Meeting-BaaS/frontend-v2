...
import { buildLoginColumns } from "@/components/microsoft-teams/logins-columns"
    ...
    return (
      <Empty className="border rounded-lg mt-8">
        <EmptyHeader>
          ...
          <EmptyDescription>
            Add a Microsoft 365 account (email + password) to start dispatching authenticated bots
            under this tenant. Each account can support up to 20 concurrent sessions.
          </EmptyDescription>
        </EmptyHeader>
        <EmptyContent>
