...
import { LoginTableActions } from "@/components/microsoft-teams/logins-table-actions"
...
export function buildLoginColumns(workspace: TeamsWorkspace): ColumnDef<TeamsLogin>[] {
  return [
    {
      id: "credential_id",
