...
import { TeamsWorkspaceTableActions } from "@/components/microsoft-teams/table-actions"
...
export const columns: ColumnDef<TeamsWorkspace>[] = [
  {
    id: "workspace_id",
      ...
      <div className="flex gap-1 items-center group">
        <div className="flex gap-3 items-center min-w-0">
          ...
          <div className="flex flex-col min-w-0">
            <Link
              href={`/microsoft-teams/${row.original.workspace_id}`}
  ...
  },
  {
    ...
    cell: ({ row }) => <TeamsWorkspaceTableActions workspace={row.original} />
  }
]
