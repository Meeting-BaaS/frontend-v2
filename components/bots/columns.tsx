...
const botColorVariants = cva("", {
  variants: {
    status: {
      // Waiting/Initial states - Gray
      pending: "bg-slate-500/10 text-slate-500",
      joining_call: "bg-slate-500/10 text-slate-500",
      in_waiting_room: "bg-slate-500/10 text-slate-500",

      // Active call states - Violet
      in_call_not_recording: "bg-violet-500/10 text-violet-500",

      // Recording states - Green
      in_call_recording: "bg-green-500/10 text-green-500",
      recording_resumed: "bg-green-500/10 text-green-500",
      recording_succeeded: "bg-green-500/10 text-green-500",

      // Paused/Warning states - Amber
      recording_paused: "bg-amber-500/10 text-amber-500",
      waiting_room_timeout: "bg-amber-500/10 text-amber-500",

      // Processing state - Violet
      transcribing: "bg-violet-500/10 text-violet-500",

      // Success/Completion - Blue
      completed: "bg-blue-500/10 text-blue-500",

      // Ended states - Slate
      call_ended: "bg-slate-500/10 text-slate-500",

      // Error/Rejected states - Red/Destructive
      failed: "bg-red-500/10 text-red-500",
      recording_failed: "bg-red-500/10 text-red-500",
      bot_rejected: "bg-red-500/10 text-red-500",
      bot_removed: "bg-red-500/10 text-red-500",
      invalid_meeting_url: "bg-red-500/10 text-red-500",
      meeting_error: "bg-red-500/10 text-red-500",
    },
  },
  defaultVariants: {
    status: "pending",
