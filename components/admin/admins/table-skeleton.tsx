...
import { columnWidths } from "@/components/admin/admins/columns"
...
const tableHeaders = [
  ...
  { label: "Name", width: columnWidths.name, style: { width: "20%" } },
  { label: "Role", width: columnWidths.role, style: { width: "12%" } },
  { label: "Status", width: columnWidths.banned, style: { width: "12%" } },
