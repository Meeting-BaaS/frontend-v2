...
function DropdownMenuCheckboxItem({
  ...
  return (
    ...
    >
      {children}
      <span className="text-muted-foreground pointer-events-none absolute right-2 flex size-3.5 items-center justify-center">
...
function DropdownMenuRadioItem({
  ...
  return (
    ...
    >
      {children}
      <span className="ml-auto pointer-events-none absolute left-2 flex size-3.5 items-center justify-center">
        <DropdownMenuPrimitive.ItemIndicator>
