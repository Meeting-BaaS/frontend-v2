...
export function ZoomTokenAlert() {
  return (
    <>
      ...
      <Alert
        variant="warning"
        className="-mx-4 md:-mx-10 lg:-mx-20 -mt-8 mb-8 rounded-none border-t-0 border-x-0 border-b-[0.5px] w-8xl"
      >
        <AlertCircleIcon />
        <AlertTitle>Uploads may be degraded</AlertTitle>
        <AlertDescription>
          <div>
            We’re currently seeing intermittent issues with S3 uploads due to an ongoing cloud
            provider incident.{" "}
            <Link
              href="https://status.scaleway.com/incidents/d7vrbhp002l1"
              target="_blank"
              rel="noopener noreferrer"
