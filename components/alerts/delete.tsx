...
export function DeleteAlertRuleDialog({
  ...
  const onSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      await axiosDeleteInstance(DELETE_ALERT_RULE(alertRule.id));
          ...
          <div className="space-y-6 pb-8">
            <div className="flex flex-col gap-1">
              <p>
                ...
                <strong>&ldquo;{alertRule.name}&rdquo;</strong>?
              </p>
              <p className="text-sm text-destructive">
                <span className="font-bold">Warning:</span> This action cannot
                be undone. All alert history for this rule will also be deleted.
              </p>
            </div>
            <FieldGroup>
              <Field>
