...
export const DELETE_ALERT_RULE = (ruleId: string) => `${ALERTS_BASE_PATH}/delete/${ruleId}`
...
export const GET_BOT_DETAILS = (botId: string) => `${BFF_BOTS_BASE_PATH}/${botId}`
export const GET_BOT_STATUS = (botId: string) => `${BFF_BOTS_BASE_PATH}/${botId}/status`
export const GET_BOT_SCREENSHOTS = (botId: string) => `${BFF_BOTS_BASE_PATH}/${botId}/screenshots`
export const LEAVE_BOT = (botId: string) => `${BFF_BOTS_BASE_PATH}/${botId}/leave`
export const DELETE_BOT_DATA = (botId: string) => `${BFF_BOTS_BASE_PATH}/${botId}/delete-data`
export const RESEND_FINAL_WEBHOOK = (botId: string) =>
  `${BFF_BOTS_BASE_PATH}/${botId}/resend-webhook`
export const RETRY_CALLBACK = (botId: string) => `${BFF_BOTS_BASE_PATH}/${botId}/retry-callback`
export const RETRANSCRIBE_BOT = (botId: string) => `${BFF_BOTS_BASE_PATH}/${botId}/retranscribe`
...
export const UPDATE_SCHEDULED_BOT = (botId: string) => `${BFF_SCHEDULED_BOTS_BASE_PATH}/${botId}`
export const DELETE_SCHEDULED_BOT = (botId: string) => `${BFF_SCHEDULED_BOTS_BASE_PATH}/${botId}`
...
export const GET_CALENDAR_EVENT_DETAILS = (calendarId: string, eventId: string) =>
...
// Meet Workspaces routes (BFF - reuses public API handlers with snake_case)
export const BFF_MEET_WORKSPACES_BASE_PATH = `${BFF_BASE_PATH}/meet-workspaces`
export const LIST_MEET_WORKSPACES = `${BFF_MEET_WORKSPACES_BASE_PATH}`
export const CREATE_MEET_WORKSPACE = `${BFF_MEET_WORKSPACES_BASE_PATH}`
export const GET_MEET_WORKSPACE = (workspaceId: string) =>
  `${BFF_MEET_WORKSPACES_BASE_PATH}/${workspaceId}`
export const UPDATE_MEET_WORKSPACE = (workspaceId: string) =>
  `${BFF_MEET_WORKSPACES_BASE_PATH}/${workspaceId}`
export const DELETE_MEET_WORKSPACE = (workspaceId: string) =>
  `${BFF_MEET_WORKSPACES_BASE_PATH}/${workspaceId}`

// Meet Logins routes (BFF - reuses public API handlers with snake_case)
export const BFF_MEET_LOGINS_BASE_PATH = `${BFF_BASE_PATH}/meet-logins`
export const LIST_MEET_LOGINS = `${BFF_MEET_LOGINS_BASE_PATH}`
export const CREATE_MEET_LOGIN = `${BFF_MEET_LOGINS_BASE_PATH}`
export const GET_MEET_LOGIN_UTILIZATION = `${BFF_MEET_LOGINS_BASE_PATH}/utilization`
export const GET_MEET_LOGIN = (credentialId: string) =>
  `${BFF_MEET_LOGINS_BASE_PATH}/${credentialId}`
export const UPDATE_MEET_LOGIN = (credentialId: string) =>
  `${BFF_MEET_LOGINS_BASE_PATH}/${credentialId}`
...
export const ADMIN_GET_BOT_DETAILS = (botId: string) => `${ADMIN_BOTS_BASE_PATH}/${botId}/details`
