...
export const metadata: Metadata = createPageMetadata({
  title: "Scheduled Bot Details",
  description: "View and manage your scheduled bot details"
})
...
export default async function ScheduledBotDetailsPage({ params }: ScheduledBotDetailsPageProps) {
  ...
  const scheduledBotDetails = await axiosGetInstance<ScheduledBotDetailsResponse>(
