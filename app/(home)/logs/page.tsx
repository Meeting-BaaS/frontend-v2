...
import { type ApiKeyListResponse, apiKeyListResponseSchema } from "@/lib/schemas/api-keys"
...
export const metadata: Metadata = createPageMetadata({
  title: "Logs",
  description: "View your API logs"
})
...
export default async function LogsPage({ searchParams }: LogsPageProps) {
  ...
  const { success, data: validatedParams } = ListApiLogsRequestQuerySchema.safeParse(params)
